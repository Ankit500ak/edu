      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Explore Our{' '}
            <span className="text-transparent bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text">Categories</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover courses across diverse fields and advance your career in the direction you choose.
          </p>
        </div>
          ...
          {categories.map((category, index) => {
            ...
            return (
              <Card
                ...
                style={{ boxShadow: '0 2px 12px #e0e7ff33', background: '#fff', minHeight: 0, height: '260px' }}
              >
                <CardContent className="flex flex-col items-center justify-center p-5 h-full" style={{ background: 'inherit', borderRadius: '1rem' }}>
                  <div
                  ...
                  <h3 className="text-sm font-bold text-blue-700 mb-1 text-center">{category.label}</h3>
                  <p className="text-xs text-gray-700 text-center mb-1">{category.description}</p>
                  <p className="text-xs text-gray-500 text-center mb-2 line-clamp-2">{category.content}</p>
